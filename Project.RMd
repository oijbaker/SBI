...
Then by choosing an appropriate set of weights and a low value of $\epsilon$, we can achieve a fit to the observed data of similar quality to that which we got using the mean squared error of raw data. The difference here is the acceptance probability, while low, is much higher than that case: 4% as opposed to 0.8%. Hence requiring less computational power due to less simulations required.
